...
// class CameraWidnows extends StatefulWidget {
//   /// Default Constructor
//   const CameraWidnows({Key? key}) : super(key: key);
//
//   @override
//   State<CameraWidnows> createState() => _CameraWidnowsState();
// }
//
// class _CameraWidnowsState extends State<CameraWidnows> {
//
//
...
//   }
//
//   //بيوقف التشغيل او لما تروحى لسكرين تانيه هيقفل الكاميرا
//   @override
//   void dispose() {
...
//   // هو ليه بيتكلم بصيغة الجمع عن الكاميرا
//   // دى بتدخل تشوف لو ف كاميرا مفتوحه
...
//   // مرحلة تعريف الكاميرا ع الويندوز
...
//   }
//
//   // احنا عارفين معنى مناديها ف dispose
...
//   }
//
//   // بياخد الصوره بعنى هيوريكى شكلك وحتى لو اتحركتى هيفضل يلقط ف صور
//   // صعب التعديل ع feature معينه جوا باكدج :(
//   Future<void> _takePicture() async {
//     final XFile file = await CameraPlatform.instance.takePicture(_cameraId);
//     _showInSnackBar('Picture captured to: ${file.path}');
//   }
//
//   // من الاسم واللى فهمته انها بتريكورد لو انتى مشغله فيديو
...
//   }
//
//   // دى اكيد ع الايقون بتاعت توقيف الفيديو .. شوفى جوا الui دى متنديه فين هتعرفى بتعمل ايه
//   // دى بتوقفه بشكل نهائى يعنى لو شغلتيه تانى هيجى من الاول
...
//   }
//
//   // فنشكن بتوقفه وتشغليه يكمل مكان ما وقفتى
...
//   }
//
//   // دى اكيد خاصه بالموبايل لان مفيش ف اللاب من ورا
...
//     }
//   }
// // لو اتقفلت بتقول بردو ف سناك بار
